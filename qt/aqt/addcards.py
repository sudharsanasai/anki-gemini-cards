...
class AddCards(QMainWindow):
    def __init__(self, mw: AnkiQt) -> None:
        ...
        self.form.btnGenerateAI.clicked.connect(self.on_generate_ai)
    ...
    def on_generate_ai(self):
        ...
        try:
            ...
            return
        if not cards:
            showWarning("No cards were generated by the LLM.")
            return
        ...
        tooltip(f"{len(cards)} cards added on topic '{topic}'!", period=2000)
